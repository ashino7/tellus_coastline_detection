...
def parse_args():
    ...
    parser.add_argument('--prediction-file', default='./input/train_annotations/train_00.json')
    parser.add_argument('--annotation-file', default='./input/train_annotations/train_00.json')
