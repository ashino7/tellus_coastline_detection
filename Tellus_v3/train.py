...
from augmentation.augmentation import get_training_augmentation, get_preprocessing
from models.net import EncoderDecoderNet, SPPNet


dir_img = 'input/train_images_png/'
dir_mask = 'input/train_images_inpainted_labels/'
...
if __name__ == '__main__':
    ...
    # config_path = Path('config/pascal_unet_res18_scse.yaml')
    # # config_path = Path('config/cityscapes_deeplabv3p.yaml')
    ...
    #     net_type = 'unet'
    #     net = EncoderDecoderNet(**net_config)
    # else:
    #     net_type = 'deeplab'
    #     net = SPPNet(**net_config)
    # net.classes = 1
